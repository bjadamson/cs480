...
namespace Compiler.Parser
{
    ...
    public class Parser
    {
        ...
        private void ParseExpressionHelper(ref string fileContents, List<Token> listOfTokens) {
        begin:
            if (last.Type == TokenType.LeftParen) {
                listOfTokens.Add(last);
                ...
                ParseExpressionHelper(ref fileContents, listOfTokens);
        ...
        private void ParseExpression(ref string fileContents, List<Token> listOfTokens) {
        ...
        private void ParseAllExpressions(ref string fileContents, Token token) {
            ...
            while (fileContents.Any()) {
                ...
                try {
                    ParseExpression(ref fileContents, listOfTokens);

                    if (listOfTokens.Count == 2 &&
                            listOfTokens[0].Type == TokenType.LeftParen && listOfTokens[1].Type == TokenType.RightParen)
                    {
                ...
                tokenList.AddRange(listOfTokens);
